...
namespace BudgetCodeTests
{
    public class TestConstants
    {
        ...
        {
            CategoryId = expense1.CategoryId,
        ...
        {
            CategoryId = expense2.CategoryId,
        ...
        {
            CategoryId = expense4.CategoryId,
        ...
        {
            CategoryId = expense5.CategoryId,
        ...
        {
            CategoryId = expense7.CategoryId,
        ...
        public static List<BudgetItemsByCategory> getBudgetItemsByCategory2018_Cat9()
        {
            ...
            list.Add(new BudgetItemsByCategory
            {
                CategoryDescription = "Credit Card",
                Details = budgetItems,
                Total = budgetItem2.Amount
            });
            return list;
